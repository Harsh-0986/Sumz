    ...
    return (
        <header className="w-full flex justify-center items-center flex-col">
            <nav className="flex justify-between items-center w-full mb-10 pt-3">
                ...
                <button type={"button"} onClick={() =>window.open('https://github.com/Harsh-0986/Sumz')} className={"black_btn"}>Github</button>
            </nav>

            <h1 className="head_text">Summarize articles with <br className={"max-md:hidden"}/>
            <span className={"orange_gradient"}>OpenAI's GPT-4</span></h1>
            <h2 className={"desc"}>
